...
bool loadMedia()
{
	...
	gBackgroundTexture = LTexture_init();
	...
	else
	{
		...
		else
		{
			...
			while( !quit )
			{
				...
				LTexture_render(gRenderer, &gBackgroundTexture, 0, 0 );

				//Render Foo' to the screen
				LTexture_render(gRenderer, &gFooTexture, 240, 190 );
